...
public class JenaEngine {
	 ...
	 *             jena
	 */
	static public Model readModel(String inputDataFile) { // create an empty model
	 ...
	 *             SparQL + Sortie: le resultat de la requete en String
	 */
	static public String executeQueryFile(Model model, String queryString) {
		
		return executeQuery(model, queryString);
	}

	/**
	 * Executer un fichier d'une requete avec le parametre * @param args + Entree:
	 * l'objet model Jena avec une chaine des caracteres SparQL + Sortie: le
	 ...
	 * Creer une Instance
	 * 
	 * @param args + Entree: - l'objet model Jena - Namespace de l'ontologie - Le
	 *             nom de le classe - Le nom de l'instance + Sortie: le resultat de
	 *             la requete en String
	 */
	static public boolean createInstanceOfClass(Model model, String namespace, String className, String instanceName) {
		...
		if ((rs2 != null) && (rs != null) && (p != null)) { // add new value
	...
	/**
	 * Mettre a jour la valeur d'une propriete objet d'une instance * @param args +
	 * Entree: - l'objet model Jena - Namespace de l'ontologie - Le nom de la
	 * premi�re Instance - Le nom de la propriete - Le nom de la deuxieme Instance +
	 * Sortie: le resultat de la requete en String
	 */
	static public boolean updateValueOfObjectProperty(Model model, String namespace, String object1Name,
		...
		if ((rs1 != null) && (rs2 != null) && (p != null)) { // remove all old values of property p
			rs1.removeAll(p);
			// add new value
	 ...
	 * Mettre a jour la valeur d'une propriete objet d'une Instance * @param args +
	 * Entree: - l'objet model Jena - Namespace de l'ontologie - Le nom de la
	 * premiere Instance - Le nom de la propriete - Le nom de le deuxieme Instance +
	 * Sortie: le resultat de la requete en String
	 */
	static public boolean addValueOfObjectProperty(Model model, String namespace, String instance1Name,
		...
		Property p = model.getProperty(namespace + propertyName);
		if ((rs1 != null) && (rs2 != null) && (p != null)) { // add new value
			rs1.addProperty(p, rs2);
			return true;
		}
		return false;
	 ...
	 * 
	 * @param args + Entree: - l'objet model Jena - Namespace de l'ontologie - Le
	 *             nom de l'Instance - Le nom de la propriete - La nouvelle valeur +
	 *             Sortie: le resultat de la requete en String
	 */
	static public boolean updateValueOfDataTypeProperty(Model model, String namespace, String instanceName,
	...
	/**
	 * Ajouter la valeur d'une propriete datatype d'une Instance * @param args +
	 * Entree: - l'objet model Jena - Namespace de l'ontologie - Le nom de
	 * l'Instance - Le nom de la propriete - La valeur + Sortie: le resultat de la
	 * requete en String
	 */
	static public boolean addValueOfDataTypeProperty(Model model, String namespace, String instanceName,
			String propertyName, Object value) {
		Resource rs = model.getResource(namespace + instanceName);
		Property p = model.getProperty(namespace + propertyName);
		if ((rs != null) && (p != null)) {
	...
	/**
	 * Supprimer toutes les valeurs d'une propriete d'une Instance * @param args +
	 * Entree: - l'objet model Jena - Namespace de l'ontologie - Le nom de
	 * l'Instance - Le nom de la propriete + Sortie: le resultat de la requete en
	 * String
	 */
